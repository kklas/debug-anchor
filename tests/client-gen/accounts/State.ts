...
export interface StateFields {
  ...
  vecField: Array<BN>
  vecStructField: Array<types.BarStructFields>
  optionField: boolean | null
  optionStructField: types.BarStructFields | null
  structField: types.BarStructFields
...
export interface StateJSON {
  ...
  vecStructField: Array<types.BarStructJSON>
  optionField: boolean | null
  optionStructField: types.BarStructJSON | null
  structField: types.BarStructJSON
  arrayField: Array<boolean>
...
export class State {
  ...
  readonly vecStructField: Array<types.BarStruct>
  readonly optionField: boolean | null
  readonly optionStructField: types.BarStruct | null
  readonly structField: types.BarStruct
  ...
  static readonly layout = borsh.struct([
    ...
    borsh.vec(types.BarStruct.layout(), "vecStructField"),
    borsh.option(borsh.bool(), "optionField"),
    borsh.option(types.BarStruct.layout(), "optionStructField"),
    types.BarStruct.layout("structField"),
  ...
  constructor(fields: StateFields) {
    ...
    this.optionStructField =
      (fields.optionStructField &&
        new types.BarStruct({ ...fields.optionStructField })) ||
      null
    this.structField = new types.BarStruct({ ...fields.structField })
    ...
    return new State({
      ...
      optionStructField:
        (dec.optionStructField &&
          types.BarStruct.fromDecoded(dec.optionStructField)) ||
        null,
      structField: types.BarStruct.fromDecoded(dec.structField),
      ...
      vecOfU8: Array.from(dec.vecOfU8),
    })
  }
  ...
  static fromJSON(obj: StateJSON): State {
    return new State({
      ...
      vecStructField: obj.vecStructField.map((item) =>
        types.BarStruct.fromJSON(item)
      ),
      optionField: obj.optionField,
      optionStructField:
        (obj.optionStructField &&
          types.BarStruct.fromJSON(obj.optionStructField)) ||
        null,
      structField: types.BarStruct.fromJSON(obj.structField),
